<?php require_once('../../private/initialize.php'); 
      ...
      if(is_post_request()) {
        ...
        if($result === true) {
          ...
          redirect_to(url_for('/admin/image_upload.php?id=' . $id));
        } else {
...
<section>
  <div class="login-form">
    ...
    <form action="<?php echo url_for('/admin/image_upload.php?id' . h(u($location->id))); ?>" method="post" enctype="multipart/form-data">
      ...
      <a href="<?php echo url_for('/admin/locations.php'); ?>" class="remove-button">Skip</a>

...
<article>
    <section class="content">
      <div class="card">
        <img src="<?php echo url_for('/images/creek.jpg'); ?>" alt="A photo of a creek and a small bridge in the woods" height="300" width="400">
        <div class="text-box">
          <h2>Who are We?</h2>
    ...
    <section class="content">
      <div class="card">
        <img src="<?php echo url_for('/images/overlook.jpg'); ?>" alt="A photo of a person standing on the rock overlooking a valley" height="300" width="400">
        <div class="text-box">
          <h2>Join Us!</h2>
